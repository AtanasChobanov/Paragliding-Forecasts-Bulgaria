...
| T-006 | Task | Create detailed site/date forecast view | Local UI / Dashboard | Takt 1 | To Do | Highest |  | 46226.0 | 46230.0 | ui,forecast-details | Build the page opened from the dashboard's detailed-forecast action and show the full cloudbase, 100+ km, 200+ km, 300+ km, overdevelopment, provenance, and driver information for one site/date. | 10.0 | 150.0 |
| T-007 | Task | Label mock, baseline, real, and missing data in the UI | Local UI / Dashboard | Takt 1 | To Do | High |  | 46228.0 | 46231.0 | ui,data-status | Make it clear when displayed values are mock, manually loaded, baseline, real, or unavailable. | 4.0 | 60.0 |

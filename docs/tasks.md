...
| T-002 | Task | Create local server skeleton | Local UI / Dashboard | Takt 1 | To Do | Highest |  | 46218.0 | 46221.0 | local-server,backend,setup | Set up a local backend or frontend dev server that starts with a documented command. | 12.0 | 180.0 |
...
| T-006 | Task | Add forecast cards for core outputs | Local UI / Dashboard | Takt 1 | To Do | Highest |  | 46226.0 | 46230.0 | ui,forecast-cards | Show cloudbase height, 100+ km chance, 200+ km chance, 300+ km chance, and overdevelopment risk. | 10.0 | 150.0 |
...
| T-009 | Task | Confirm launch coordinates and region radii | Flight Data Collection | Takt 1 | To Do | High |  | 46218.0 | 46231.0 | locations,data-quality | Confirm exact coordinates, aliases, and catchment radius for every target location, especially Pastrona and Dobrich region. | 8.0 | 120.0 |
